...
| LLM Assisted Recipe Mapping (`auto_map.rb`) | 🚫 | Feature 6 — not built yet; will replace manual seeding |
...
|---|---|
| Auto-map (`auto_map.rb`, Feature 6) | After implementation — verify Telegram report, DB writes |
